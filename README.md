...
看图题、连线题等纯文本无法表达的题，会自动从原图里裁出小图嵌进 PDF（题干 + 嵌入图 + 空白作答区）。
...
> **📷 拍照建议**（直接影响识别准确率）：
>
> - **平铺、压平**：试卷尽量铺平，避免折痕弯曲让文字变形
> - **正上方拍**：手机正对试卷，避免侧拍带透视
> - **自然光、避免阴影**：打开窗、把手机阴影错开试卷；台灯单侧打光容易产生半边阴影
> - **整页入框 + 留白**：试卷边缘到画面边缘留 1-2cm，别裁掉题号
> - **分辨率别压**：发图时不要选"小图/压缩"，否则红笔细节糊掉
> - **一题一面更稳**：A3 双面或多页试卷可以拆开拍多张，Claude 会自动合并
